...
<div class="container size">
	<div class="row">
		<div class="col-md-6 offset-md-3 form-container">
          ...
          <!-- Error Messages -->
              ...
              <input type="text" name="contact_no" value="" placeholder="91********" class="form-control" required pattern="^\d{11}$" title="11 numeric characters only" maxlength="11">
            </div><!--End form-group-->
					<div class="form-group">
	...
	<optgroup title="Manipur " label="&raquo; Manipur"></optgroup><option value="Imphal" >Imphal</option>
    ...
    <optgroup title="West Bengal" label="&raquo;West Bengal"></optgroup><option value="Kolkata" >Kolkata</option></select>
            </div><!--city end-->
            <div class="form-group">
