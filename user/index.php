				...
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<a button style="margin-top: 20px;"id="save_the_life" class="btn btn-lg btn-danger center-aligned "href="donate.php">Save The Life</a></button>
							<div class="test-success text-center" id="data" style="margin-top: 20px;"><!-- Display Message here--></div>
							<div class="row">
								<div class="column"><img src="donate.jpg" style="width:350px;height: 300px"alt="donate"></div>
								<div class="column"><img src="save.jpg" style="width:400px;height: 300px"alt="save"></div>
								<div class="column"><img src="care.jpg" style="width:350px;height: 300px"alt="care"></div>
						</div>
					</div>
				</div>
			</div>
